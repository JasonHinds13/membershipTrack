    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auxilliary', models.CharField(blank=True, max_length=255, null=True, choices=[(b'Brotherhood', b'Brotherhood'), (b"Women's Federation", b"Women's Federation"), (b"Usher's Board", b"Usher's Board"), (b'Youth Fellowship', b'Youth Fellowship'), (b'Young Adult', b'Young Adult'), (b"Decon's Board", b"Decon's Board")])),
                ...
                ('how_can_the_church_contact_you', models.CharField(blank=True, max_length=255, null=True, choices=[(b'Email', b'Email'), (b'Text', b'Text'), (b'Both', b'Both'), (b'Neither', b'Neither')])),
